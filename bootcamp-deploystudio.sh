...
DSLOC="/tmp/DSNetworkRepository/Packages"
...
{
	NAME="$1"
	TOOLS_FOLDER="$DSLOC/$NAME.pkg/Contents/Resources/"

	logme "Installing $NAME.pkg"
	echo "RuntimeSelectWorkflow: Z Install "$1" (script selected)"
...
case "$MODELID" in
	...
	#Note that 13-inch, Mid 2010 is MacBookPro7,1 and gets Boot Camp 4
